...
1.3 Check if the _Allow USB debugging_ popup appears on device screen.

1.3.1 If no popup appears skip the following command and go to Section 2

1.3.2 If permission popup appears, then check _Allow always on this computer_ (optional) and tap OK. 
...
2.2 Follow (https://developer.android.com/studio/run/device) to add user in plugdev group and install android-sdk-platfrom-tools-common for udev rules
